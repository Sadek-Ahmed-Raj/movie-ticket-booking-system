...
1. Booking a seat successfully
2. Attempting to book an already reserved seat (should fail)
3. Cancelling a booking and confirming the seat becomes available
4. Editing ticket information and verifying updates
5. Searching a ticket by name or ID
6. Confirming correct available/sold counts in the summary

## 👥 Team Members

| Student Name | Student ID |
|---|---|
| Md. Sadek Ahmed Raj | 251-15-511 |
...
2. Online C Tutorials: w3schools.com, TutorialsPoint
